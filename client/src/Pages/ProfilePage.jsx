...
const PorfilePage=() =>{
   ...
   const navigate = useNavigate()
    const [name,setName]=useState("Vishal Singh");
    const [bio,setBio] = useState("Hi everyone i am Vishal Singh")
        ...
        <input onChange={(e)=>setName(e.target.value)} value={name}
         type="text" required placeholder="Your Name" className="p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 
          ...
          <textarea  onChange={(e)=>setBio(e.target.value)} value={bio}
           ...
           border-gray-500 rounded-md focus:ring-2 focus:ring-violet-500 " rows={4}></textarea>
