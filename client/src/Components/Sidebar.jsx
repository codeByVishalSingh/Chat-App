    ...
    return (
       ...
       <div className="pb-5">
        <div className="flex justify-between item-centre">
            ...
            <div className="relative py-2 group">
               ...
               bg-[3282142] border border-gray-600 text-gray-100 hidden
               group-hover:block">
     ...
     <div className="bg-[#282142] rounded-full flex items-centre gap-2 py-3 px-4 mt-5">
       ...
       <div className="flex flex-col">
            ...
            key={index}
            className={`relative flex items-centre gap-2 p-2 p1-4
            rounded cursor-pointer max-sm:text-sm
             ${selectedUser?._id === user._id && 'bg-[#282142]/50'} `}>
               ...
               <p>{user.fullName}</p>
               {
                ...
                {index > 2 && <p className="absolute top-4right-4 text-xs h-5 w-5
                flex-justif-centre items-centre rounded-full bg-voilet-500/50  ">
                    {index} </p>}
            </div>
             ))}
       </div>
